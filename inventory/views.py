...
branded version of the same data over the API, but a deployment that has no
frontdoor -- another organisation running this by itself -- still needs a way to
look at its own stock.
